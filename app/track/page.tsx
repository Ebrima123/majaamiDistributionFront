...
const mockTrackingDatabase: Record<string, any> = {
  'MAJ-1001': {
    ...
    milestones: [
      ...
      },
      {
        ...
        timestamp: 'Sept 15, 2026 - 04:45 PM',
        location: 'Serekunda Retail Hub',
        status: 'completed',
      },
    ],
  ...
  'MAJ-DEMO': {
    trackingNumber: 'MAJ-DEMO',
    status: 'out_for_delivery',
    origin: 'Banjul Central Depot',
    destination: 'Basse Santa Su Market',
    ...
    milestones: [
      {
        ...
        title: 'Order Processed',
        description: 'Your shipment has been received and processed',
        timestamp: 'Sept 18, 2026 - 08:00 AM',
        location: 'Banjul Central Depot',
        status: 'completed',
      },
      {
        ...
        title: 'Received at Central Depot',
        description: 'Package sorted and prepared for dispatch',
        timestamp: 'Sept 18, 2026 - 09:30 AM',
        location: 'Banjul Central Depot',
        status: 'completed',
      },
      {
        id: '3',
        title: 'In Transit via Northern Route',
        description: 'Shipment en route to destination',
        timestamp: 'Sept 18, 2026 - 11:00 AM',
        location: 'Farafenni Junction',
        status: 'completed',
      },
      {
        id: '4',
        title: 'Out for Delivery',
        description: 'Package with delivery driver - Currently in transit',
        timestamp: 'Sept 18, 2026 - 02:00 PM',
